...
SECRET_KEY = 'django-insecure-do_9gn+4q$*sfr_wq7nt2bc=yl$x7_w_836x@ho48nownx9-3n'
...
INSTALLED_APPS = [
    'django.contrib.admin', # use for admin interface 
    'django.contrib.auth', # use for authenticating users
    'django.contrib.contenttypes', # 
    'django.contrib.messages',  # use for displaying one time notification to the user
    'django.contrib.sessions',  # session is a temporory memory on the server for managing users data
...
MIDDLEWARE = [  # a function that take a req and either pass it to the next middleware or return a responce, if the middleware returns aresponce the request won't be passes to next one
